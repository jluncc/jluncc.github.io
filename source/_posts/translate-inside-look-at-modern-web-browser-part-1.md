...
![图 1：CPU 芯片像坐在办公室的上班族，处理到来的任务](/images/translate-inside-look-at-modern-web-browser-part-1/CPU.png)
...
![图 2：许多拿着扳手的 GPU 芯片表明他们能处理有限的任务](/images/translate-inside-look-at-modern-web-browser-part-1/GPU.png)
...
![图 3：计算机的三层架构。机器硬件位于底层，操作系统处于中间，上层是应用程序](/images/translate-inside-look-at-modern-web-browser-part-1/hw-os-app.png)
图 3：计算机的三层架构。机器硬件位于底层，操作系统处于中间，上层是应用程序。  

## 在进程和线程上执行程序  

![图 4：进程就像一个有边界的盒子，而线程好比在一个进程里面游泳的抽象的鱼](/images/translate-inside-look-at-modern-web-browser-part-1/process-thread.png)
...
![图 5：一个进程使用内存空间以及存储应用程序数据的图解](/images/translate-inside-look-at-modern-web-browser-part-1/memory.png)
...
![图 6：隔离的进程间通过 IPC 进行通信的图解](/images/translate-inside-look-at-modern-web-browser-part-1/workerprocess.png)
...
![图 7：不同浏览器架构中的进程/线程图](/images/translate-inside-look-at-modern-web-browser-part-1/browser-arch.png)
图 7：不同浏览器架构中的进程/线程图  
...
![图 8：Chrome 的多进程架构图。渲染器进程下显示多个图层，表示 Chrome 为每一个 tab 运行多个渲染器进程](/images/translate-inside-look-at-modern-web-browser-part-1/browser-arch2.png)
...
![图 9：不同的进程指向浏览器用户界面中的不同部分](/images/translate-inside-look-at-modern-web-browser-part-1/browserui.png)
...
![图 10：该图显示每个 tab 运行着多个进程](/images/translate-inside-look-at-modern-web-browser-part-1/tabs.png)
...
![图 11：Chrome 的 servicification 将不同的服务转移到多进程中和一个浏览器进程中](/images/translate-inside-look-at-modern-web-browser-part-1/servicfication.png)
...
![图 12：站点隔离图，多个渲染器进程指向 一个站点内的 iframe](/images/translate-inside-look-at-modern-web-browser-part-1/isolation.png)
